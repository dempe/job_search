...
Source: [[Jobs/Job Applications/Enveritas]]
...
```
When a new EUDR request comes in, what's the process from interpretation to workable solution?  Who are the stakeholders, and how are conflicting interpretations between them resolved?
```
