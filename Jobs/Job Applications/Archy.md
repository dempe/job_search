...
Answer: [[Jobs/Answers/Archy application letter#Archy|Archy application letter]]
...
Answer: [[Jobs/Answers/Building the DataRank crawler framework#Archy|Building the DataRank crawler framework]]
