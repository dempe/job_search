...
```
Afresh's mission, to tackle food waste, is what excites me most about Afresh. Believe it or not, this is a problem I think about all the time at my house (ask my wife!).  Moreover, you guys are doing it in a way that actually works for grocers. That's something I can get on board with!

On the technical side, the Ordering role lines up with where I've spent my career. I've built distributed, event-driven backend systems for over a decade now. At Octimine, for example, I replaced a 48-hour weekly batch job with a real-time Kafka pipeline.

I'm also excited about the ownership and mentorship side of this role. I've spent the past few years running my own company, and I'm ready to get back on a team. I do my best work and learn the most in collaboration, and I'd love to help guide junior engineers while growing into more technical leadership myself.
...
```
As compelling as the tech stack and company culture sound, the thing that most excites me about Enveritas is the actual company mission.

I worked as an English teacher in Mexico (Mexico City and Veracruz) for two years. Some of the students I taught were extremely poor. Actually helping them learn and motivate them was, by far, the most fulfilling experience of my life.

After going back to software engineering, I've missed having that sense of fulfillment in my work. Enveritas feels like an opportunity to get that back.
```
...
```
I've used backend technologies for a decade now. I've started using frontend tech in the last few years.  I've found that I really enjoy developing products end-to-end, rather than exclusively staying in the backend.  I like seeing how everything fits together and the sense of ownership that comes with that.

I would love to continue to grow as a fullstack engineer, especially while doing impactful work that actually makes people's lives easier.  That's why this role at JustPaid excited me so much!
```
...
```
The US has an incarceration problem. The idea of using tech and data-driven technology to tackle this problem is something that I can wholeheartedly get behind. I've spent years building cloud-native systems, mobile tools, and data pipelines. The idea of applying those same skills toward something that *measurably* improves people's lives is very exciting. I would love to be a part of the team at Recidiviz and build something meaningful rather than just another commercial app.
```
