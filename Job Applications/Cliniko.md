...
Answer: [[Backend engineering background#Cliniko|Backend engineering background]]

> What one thing do you think new software developers should know that isn't ordinarily taught?

Answer: [[Asking good questions in software development#Cliniko|Asking good questions in software development]]

> What is the result of this line of pseudocode? [1, 2, 3].map(multiplyByTwo).reduce(add)

Answer: [[Pseudocode exercise#Cliniko|Pseudocode exercise]]
